...
class ViewController: UIViewController, UIPopoverPresentationControllerDelegate {
    ...
    @IBAction func fiveAMSwitch(sender: AnyObject) {
        ...
        if fiveAMs.on == true {
           time1 = "5:00 AM"
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 5, minute: 00) // 4
    ...
    @IBAction func sixAMSwitch(sender: AnyObject) {
        ...
        if sixAMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 6 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func sevenAMSwitch(sender: AnyObject) {
        ...
        if sevenAMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 7 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func eightAMSwitch(sender: AnyObject) {
        ...
        if eightAMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 8 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func nineAMSwitch(sender: AnyObject) {
        ...
        if nineAMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 9 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func tenAMSwitch(sender: AnyObject) {
        ...
        if tenAMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 10 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func elevenAMSwitch(sender: AnyObject) {
        ...
        if elevenAMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 11 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func twelvePMSwitch(sender: AnyObject) {
        ...
        if twelvePMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 12, minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func onePMSwitch(sender: AnyObject) {
        ...
        if onePMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 13, minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func twoPMSwitch(sender: AnyObject) {
        ...
        if twoPMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 14 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func threePMSwitch(sender: AnyObject) {
        if threePMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 15 , minute: 03) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func fourPMSwitch(sender: AnyObject) {
        ...
        if fourPMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 16 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func fivePMSwitch(sender: AnyObject) {
        ...
        if fivePMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 17 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func sixPMSwitch(sender: AnyObject) {
        ...
        if sixPMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 18 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func sevenPMSwitch(sender: AnyObject) {
        ...
        if sevenPMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 19 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func eightPMSwitch(sender: AnyObject) {
        ...
        if eightPMs.on == true {
           ...
           time16 = "8:00 PM"
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 20 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func ninePMSwitch(sender: AnyObject) {
        ...
        if ninePMs.on == true {
           ...
           time17 = "9:00 PM"
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 21 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
    ...
    @IBAction func tenPMSwitch(sender: AnyObject) {
        ...
        if tenPMs.on == true {
            ...
            localNotification.alertAction = "Meal Time" // 2
            localNotification.alertBody = "It's time to chow down!" // 3
            localNotification.fireDate = self.createDateWithTime(NSDate(), hour: 22 , minute: 00) // 4
            localNotification.soundName = UILocalNotificationDefaultSoundName
